...
?>
    ...
    <div class="container">
      ...
      <h1>Liste des Voitures <a href="export_cars.php"><img src="images/csv.png" width="40"></a></h1>
...
foreach($inscrits as $objet){
  ...
  <tr>
    ...
    <td>
    <button onclick=\"update('".$objet->id_voiture."','".$objet->immat."','".$objet->marque."','".$objet->modele."','".$objet->annee."','".$objet->photo."','".$objet->tarif_jour."')\" class='btn btn-success' data-bs-toggle='modal' data-bs-target='#update'><i class='bi bi-pencil-square'></i></button>
    
    <form class='d-inline' method='post' action='deleteVoiture.php'>
    <input type='hidden' name='id_voiture' id='id_voiture' value='".$objet->id_voiture."'>
    <button type='submit' onclick=\"return confirm('etes vous sure de supprimer?')\" class='btn btn-danger'><i class='bi bi-trash3-fill'></i></button>
    </form>
    </td>
  </tr>
  ";
