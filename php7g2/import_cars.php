...
<?php
      ...
      ?>
    <form class="row g-3 needs-validation" method="post" action="traitement_csvCar.php" novalidate enctype="multipart/form-data">

        <div class="col-md-6">
          <label for="csv" class="form-label"><i>Importer csv</i></label>
          <input type="file" name="csv"  class="form-control" id="csv" required>
          <div class="invalid-feedback">
            Veuillez parcourir une voiture à importer.
          </div>
        </div>
