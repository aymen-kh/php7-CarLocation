...
$sql = "SELECT date_debut,date_fin,photo,cars.immat,cout_total FROM location,cars  
WHERE cars.id_voiture=location.id_voiture and id_client = " . $_SESSION['id'];
...
foreach($location as $objet){
  ...
  <tr>
    ...
    <td><a href='#' class='btn btn-primary btn-lg active' role='button' title='Lien 1'>Payer</a></td>
